...
import com.example.mirela.appAndroid.ui.AddActivity
import com.example.mirela.appAndroid.ui.UpdateActivity
...
//        outState?.putParcelableArrayList("items", adapter.getChocolatesList() as ArrayList<Chocolate>)
    }
