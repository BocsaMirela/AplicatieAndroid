package com.example.mirela.appAndroid.ui
...
import com.example.mirela.appAndroid.ui.fragments.DatePickerFragment
import com.example.mirela.appAndroid.utils.SessionManager
import com.example.mirela.appAndroid.ui.fragments.TimePickerFragment
import java.io.File
...
class AddActivity : AppCompatActivity(), DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val mailBtn = findViewById<FloatingActionButton>(R.id.addMail)
    ...
    fun onEmail() {
        ...
        builder.setView(view)
            .setPositiveButton(
                ...
                val addresses = view.findViewById<EditText>(R.id.email).text.toString()
                val subject = view.findViewById<EditText>(R.id.extraSubject).text.toString()
